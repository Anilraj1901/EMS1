            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    if (row != null) {
                        ...
                        dropdown += '<option value="item0">Select Your Department</option>';
                        dropdown += '<option value="Development">Development</option>';
                        dropdown += '<option value="Management">Management</option>';
                        dropdown += '<option value="Human Resource">Human Resource</option>';
                        dropdown += '<option value="Bussiness">Bussiness</option>';
                        dropdown += '</select>';
                    }
                    else {
